            ...
            <div class="col-md-12">
                ...
                <div class="profile-sidebar">
                    <div class="card">
                        <div class="card-body no-padding height-9">
                            <div class="row">
                                <img src="{{ asset('storage/'. Auth::guard('kasir')->user()->photo_profil) }}" class="img-responsive" alt="Photo Profil {{ auth()->user()->nama }}">
                            </div>
                ...
                <div class="profile-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body no-padding height-9">
                            <div class="profile-desc">
                                <img src="{{ asset('storage/'.Auth::guard('kasir')->user()->photo_ktp) }}" class="img-responsive" alt="Photo Profil {{ auth()->user()->nama }}">
                            </div>
                        </div>
                    </div>
                    <!-- End Kartu Identitas -->
