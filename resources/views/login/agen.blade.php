			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Sales Login</h2>
						<form action="{{ route('login.agen') }}" method="POST" class="register-form" id="register-form">
                            @csrf
					...
					<div class="signup-image">
						<figure><img src="{{ asset('assets/img/signup.jpg') }}" alt="sing in image"></figure>
					</div>
				</div>
			</div>
		</section>
