            ...
            <div class="col-md-12">
                        ...
                        <div class="card-body no-padding height-9">
                            <div class="row">
                                <div class="profile-userpic">
                                    <img src="{{ asset('storage/'.$pelanggan->photo) }}" class="img-responsive" alt="Photo Profil {{ $pelanggan->nama }}">
                                </div>
                            </div>
                            <div class="profile-usertitle">
                                <div class="profile-usertitle-name"> {{ $pelanggan->nama }} </div>
                                <div class="profile-usertitle-job"> <b>{{ ucwords($pelanggan->kategori) }}</b> </div>
                            </div>
                        ...
                        <div class="card-body no-padding height-9">
                            ...
                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Kontak </b>
                                    <div class="profile-desc-item pull-right">{{ $pelanggan->kontak }}</div>
                                </li>
                                <li class="list-group-item">
                                    <b>Mulai Berlangganan </b>
                                    <div class="profile-desc-item pull-right">{{ $pelanggan->created_at }}</div>
                                </li>
                                {{-- <li class="list-group-item">
                                    <b>Degree </b>
                ...
                <div class="profile-content">
                    <div class="row">
                        <div class="card">
                            <div class="card-head">
                                <header>Grafik Pembelian Pelanggan</header>
                                <div class="tools">
